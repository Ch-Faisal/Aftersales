...
function Warranty() {
  ...
  <tbody className='text-center'>
    <tr>
      <td className='fw-light regular-bg' style={{ verticalAlign: 'middle'}} rowspan="2">Regular</td>
      <td className="regular-bg">TGB Maintenance Free</td>
      <td className='test test-bg fw-bold'>1 Tahun / 20.000 km*</td>
    </tr>
    <tr>
      <td className="regular-bg">TGB Standard Type</td>
      <td className='test test-bg fw-bold'>1 Tahun / 20.000 km*</td>
    </tr>
    <tr>
      <td className='fw-light hybrid-bg'>Hybrid</td>
      <td className='hybrid-bg'></td>
      <td className='fw-bold'>8 Tahun / 160.000 km*</td>
    </tr>
    <tr>
      <td className='fw-light regular-bg'>Electric</td>
      <td className='regular-bg'></td>
      <td className='test-bg fw-bold'>8 Tahun / 160.000 km*</td>
    </tr>
  </tbody>
</table>
                                <p className='custom_text_colors'>
                                *Berlaku di seluruh dealer resmi Toyota. Untuk beberapa partshop partner Toyota berlaku 1 Tahun. <br />** Mana yang tercapai lebih dahulu. <br />*** Khusus untuk hybrid battery/aki, warranty berlaku selama 8 tahun dengan 3 tahun pertama sesuai ketentuan manufaktur dan tambahan 5 tahun sesuai ketentuan Toyota Astra Motor.
                    ...
                    <div className='container mt-5'>
                        <div className='row align-items-center'>
                            ...
                            <div className='col-12 col-md-7 text-start mt-3 mt-md-0'>
                                ...
                                <b>12 bulan / 20.000 km</b>
                                <p className='custom_text_colors mt-1'>
                                Tuntutan warranty akan dikabulkan dengan syarat pembelian dan pemasangan dilakukan di bengkel resmi Toyota.
                                </p>
                            </div>
                        </div>
