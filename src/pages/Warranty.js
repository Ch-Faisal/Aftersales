...
function Warranty() {
        ...
        <div className='container-fluid'>
            ...
            <div className='container mt-5'>
                <div className='row align-items-center custom-bg-gray-dark'>
                    <div className='col-4 custom-bg-gray-dark d-flex justify-content-center align-items-center'>
                        <p>Aturan Dasar</p>
                    </div>
                    <div className='col-8 text-start custom-bg-gray p-5'>
                    <ul className='custom-list-style-number'>
                ...
                <div className='row align-items-center custom-bg-gray'>
                    <div className='col-4 custom-bg-gray d-flex justify-content-center align-items-center'>
                        <p>Hal-hal dan Komponen yang Tidak Ditanggung Warranty</p>
                    </div>
                    <div className='col-8 text-start custom-bg-gray-dark p-5'>
                    <ul className='custom-list-style-number'>
  ...
  <tbody className='text-center'>
    <tr>
      ...
      <td className='fw-bold'>1 Tahun / 20.000 km*</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td className='fw-bold'>8 Tahun / 160.000 km*</td>
                    ...
                    <div className='col-6'>
                        <img src="assets/hidecar.png" className='w-100' />
                    </div>
                </div>
                </div>
            </div>
            ...
            <div className='container mt-5 mb-5'>
                <div className='row justify-content-center'>
                    <div className='col-6'>
                        <img src="assets/threeicons.png" className='w-100' />
                    </div>
                </div>
                </div>
        </div>
