...
function Products() {
  ...
  const toggleVisibility1 = () => {
    ...
    // } else {
    //     console.error("Element with class 'mySwiper' not found");
    // }

    // const element1 = document.querySelector('.mySwiper .card');
    // if (element1) {
    //     element1.style.setProperty('height', '32rem', 'important');
    // } else {
    //     console.error("Element with class 'card' inside '.mySwiper' not found");
    // }
  ...
  const toggleVisibility5 = () => {
    ...
    const toggleVisibility7Element = document.getElementById('toggleVisibility6');
    const isW100 = toggleVisibility6Element.classList.contains('w-100');
    const W100 = toggleVisibility7Element.classList.contains('w-100');
    if (isW100) {
    ...
    if (W100) {
      toggleVisibility7Element.classList.remove('w-100');
      toggleVisibility7Element.classList.add('w-75');
    }
  ...
  const toggleVisibility6 = () => {
    ...
    const toggleVisibility7Element = document.getElementById('toggleVisibility5');
    const isW100 = toggleVisibility6Element.classList.contains('w-100');
    const W100 = toggleVisibility7Element.classList.contains('w-100');
    if (isW100) {
      toggleVisibility6Element.classList.remove('w-100');
                      ...
                      <div className="container ps-lg-5 pe-lg-5 ps-md-5 pe-md-5 ps-2 pe-2 mt-5">
                        <div className="row">
                          <div className="col-12">
                            ...
                            <iframe className="w-100 rounded-4" height="500" src="https://www.youtube.com/embed/oOlvwZbXUiY?si=emBVIEEjm7orOTbC" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
