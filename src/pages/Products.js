...
selalu optimal</span></p>
        ...
        <div className='container-fluid px-0 overflow-x-hidden'>
            ...
            <h1>Market Valuable Parts (MVP)Toyota Genuine Parts</h1>
            ...
            <div className='row'>
                            <div className='col-12'>
            <p className='title'>Toyota PRODUCT - service parts</p>
            <h1>Market Valuable Parts (MVP)</h1>
          ...
          <img className='ps-2' src='assets/CROSS.svg'/>
                    ...
                    >
                        <div className="container ps-5 pe-5 mt-5">
                          <div className='row'>
                            <div className='col-12'>
                        <p className='title'>Toyota PRODUCT -TMO</p>
            <h1>Lubricant - TMO Engine Oil</h1>
            <p>Minyak pelumas yang digunakan untuk melumasi dan melindungi bagian-bagian mesin mobil.</p>
            </div>
            </div>
                        </div>
                        <div className="container">
  <div className='row'>
    ...
    <div className="card">
        ...
        <div className='text-lg-start text-md-start text-center'>
          <h4>Synthetic</h4>
          <p>Memiliki keunggulannya tidak mudah menguap dan kemampuan pelumasannya lebih merata.</p>
          <div className='mt-5'>
            <a href='#'>Cek Produk</a>
            <img className='ps-2' src='assets/CROSS.svg'/>
          </div>
    ...
    <div className="card">
        ...
        <div className='text-lg-start text-md-start text-center'>
          ...
          <p>Memiliki kemampuan pelumasan paling baik, tahan terhadap suhu tinggi dan mampu meningkatkan efisiensi konsumsi bahan bakar lebih hemat bahan bakar.</p>
          <div className='mt-5'>
            <a href='#'>Cek Produk</a>
            <img className='ps-2' src='assets/CROSS.svg'/>
          </div>
                      ...
                      <div className='row'>
                            <div className='col-12'>
                        <p className='title'>Toyota PRODUCT -TMO</p>
            <h1>Lubricant - TMO Non Engine Oil</h1>
            <p>Minyak pelumas yang digunakan untuk melumasi dan melindungi bagian-bagian selain mesin mobil</p>
            </div>
            </div>
            <div className="container">
        <OwlCarousel
        ...
        >
          ...
          <div className='text-start'>
          <h4>TMO Differential Gear Oil</h4>
          <p>Pelumas oil gardan (differential) yang ditujukan untuk penggunaan kendaraan berpenggerak roda belakang (RWD)</p>
          </div>
        </div>
            </div>
            <div className="item">
          ...
          <div className='text-start'>
          <h4>TMO Transfer Gear Oil</h4>
          <p>Pelumas yang digunakan pada kendaraan 4WD sebagai pelindung chain dan bearing. Tanpa adanya oli transfer, gigi akan sulit berputar dan mobil pun terasa berat saat dijalankan.</p>
          </div>
        </div>
            </div>
            <div className="item">
          ...
          <div className='text-start'>
          <h4>TMO Manual Transmission Fluid</h4>
          <p>Pelumas yang dirancang khusus untuk memberikan pelumasan, mengurangi gesekan, dan mendinginkan komponen dalam transmisi manual.</p>
          </div>
        </div>
            </div>
                      ...
                      <div className='row'>
                        ...
                        <p className='title'>Toyota PRODUCT -TMO</p>
            <h1>Chemical Care</h1>
            <p>Hadirkan ketenangan dengan perbaikan Bodi TOYOTA di tangan yang paling berpengalaman Hadirkan ketenangan dengan perbaikan Bodi TOYOTA di tangan yang paling berpengalaman Hadirkan ketenangan dengan perbaikan Bodi TOYOTA di tangan yang paling berpengalaman</p>
            </div>
            </div>
            <div className='row custom_slide_design'>
            <Swiper
          ...
          <div className="card">
            <div className='custom_box_shadow'>
              ...
              <div className="card-body custom-color-body text-start">
                ...
                <p className="card-text text-start ps-lg-5 ps-3 pt-3">{slideContent.description}</p>
              </div>
            </div>
          </div>
        </SwiperSlide>
            ...
            <div className="container mt-5">
                      <div className='row'>
                        ...
                        <p className='title'>Toyota PRODUCT -TMO</p>
            <h1>TMO TGRI</h1>
            <p>General Repair atau biasa di singkat GR adalah sebuah perbaikan kendaraan yang lebih memperhatikan tentang kesehatan mesin mobil, baterai mobil dan komponen - komponen didalam mobil itu sendiri agar tetap sehat dan aman digunakan.</p>
            </div>
            </div>
            </div>
            <div className="container">
  <div className='row'>
    <div className='col-lg-6 col-md-6 col-12'>
      <div className="card">
        ...
        <div className='text-lg-start text-md-start text-center'>
          <h4>TMO TGRI Motor Oil 0W-20 API-SP</h4>
          <p>Mendukung stabilitas performa mesin kendaraan dan memberikan performa maksimal untuk penggunaan racing dan harian kendaraan Toyota dengan bahan bakar bensin.</p>
        </div>
      </div>
    </div>
    <div className='col-lg-6 col-md-6 col-12'>
      <div className="card">
        ...
        <div className='text-lg-start text-md-start text-center'>
          <h4>TMO TGRI Injector Cleaner Gasoline</h4>
          <p>Didukung dengan formula khusus untuk mengurangi serta membersihkan karbon dan endapan di dalam injektor dan ruang pembakaran.</p>
        </div>
      </div>
    </div>
  </div>
            ...
            <div className='row'>
                            <div className='col-12'>
            <p className='title'>Toyota PRODUCT - TGB</p>
            <h1>TGB Maintenance Free</h1>
            <p>Toyota Genuine Battery Maintenance Free Type merupakan tipe aki kering untuk mobil Toyota dengan standard kualitas Toyota</p>
    ...
    <div className='row d-flex pt-3 text-start ms-lg-5 me-lg-5'>
    <div className='col-sm-12 col-lg-6 col-md-6 d-flex align-items-center'>
      <img src='assets/svg1.svg' alt='svg1'/>
      <p className='custom-padding'>Didesain khusus untuk iklim tropis Indonesia</p>
    </div>
    <div className='col-lg-6 pt-sm-3 pt-3 pt-md-0 pt-lg-0 col-md-6 col-sm-12 d-flex align-items-center'>
    ...
    <div className='row'>
                            <div className='col-12'>
            <p className='title'>Toyota PRODUCT - TGB</p>
            <h1>TGB Standard Type</h1>
            <p>Toyota Genuine Battery Standard Type merupakan tipe aki basah untuk mobil Toyota dengan standard kualitas Toyota</p>
    ...
    <div className='row'>
                            <div className='col-12'>
            <p className='title'>Toyota PRODUCT</p>
            <h1>Tire Solution</h1>
            <p>Layanan penggantian ban di outlet resmi Toyota dengan keunggulan <span className='custom_color'>produk ban bervariasi</span> (tersedia berbagai macam merk & tipe) serta memberikan <span className='custom_color'>kualitas ban terbaik</span> (usia produksi ban terbaru)</p>
            </div>
            </div>
            </div>
            <div className='container mt-5 custom-bg-color'>
              <div className='row mt-4'>
                <div className='col-12 mt-3 ms-md-3 me-md-3 ms-0 me-0'>
                  <h1 className='ms-3 me-3'>Perhatikan ciri-ciri Ban Mobil yang Dapat Membahayakan di Perjalanan</h1>
                </div>
              </div>
              <div className='row ms-md-3 me-md-3 ms-0 me-0 ms-lg-5 me-lg-5 mt-4 mb-5'>
                <div className='col-lg-4 mb-0 col-md-6 col-sm-12 pt-0 pt-lg-0 mb-4'>
                  <div className='custom_border'>
                    <div className='d-flex custom_padding align-items-center text-start half_card'>
                      <h3 className='custom_color custom_style ps-3'>1</h3>
                      <p className='custom_color ps-3 pe-3 pt-2'>Usia ban yang sudah lama / Jarak tempuh ban yang sudah tinggi</p>
                    </div>
                ...
                <div className='custom_border'>
                    <div className='d-flex custom_padding align-items-center text-start half_card'>
                      <h3 className='custom_color custom_style ps-3'>2</h3>
                      <p className='custom_color ps-3 pe-3 pt-2'>Ban Tipis /  Gundul</p>
                    </div>
                    <div className='custom_color_card ps-3'>
                    <p className='custom_font_p ps-3 pe-3 pt-2 text-start'>
...
<div className='custom_border'>
                    <div className='d-flex custom_padding align-items-center text-start half_card'>
                      <h3 className='custom_color custom_style ps-3'>3</h3>
                      <p className='custom_color ps-3 pe-3 pt-2'>Ban Sobek / Retak / Benjol /  Banyak Tambalan</p>
                    </div>
                    <div className='custom_color_card ps-3'>
                    <p className='custom_font_p ps-3 pe-3 pt-2 text-start'>
            ...
            <div className='container'>
                ...
                <div className='col-12'>
                  <h1>Panjang Pengereman Terhadap Kedalaman Ban</h1>
                  <img src='assets/Asset_6.png' className='img-fluid mt-5 mb-5'/>
                </div>
              </div>
            </div>
  ...
  <div className="container pt-5 pb-5">
    <div className='row'>
      <div className='col-12'>
        <h1>Keunggulan Mengganti Ban di Toyota</h1>
      </div>
    </div>
    <div className="row justify-content-center pt-3">
      <div className="col-lg-2 col-md-4 col-6">
        <div className="card cards_custom_design align-items-center">
          ...
          <p className='card_heading pt-2'>Produk Ban Bervariasi</p>
          <p className='card_text pb-4'>Tersedia berbagai macam merk & tipe</p>
        </div>
      </div>
      <div className=" col-lg-2 col-md-4 col-6">
        <div className="card cards_custom_design align-items-center">
          <img src="assets/card-icon-2.png" className='pt-2' alt="Logo"/>
          <p className='card_heading pt-2'>Kualitas Ban Terbaik</p>
          <p className='card_text pb-4'>Usia Produksi Ban Terbaru</p>
        </div>
      </div>
      <div className="col-lg-2 col-md-4 col-6 pt-3 pt-lg-0 pt-md-0">
        <div className="card cards_custom_design align-items-center">
          <img src="assets/card-icon-3.png" className='pt-2' alt="Logo"/>
          <p className='card_heading pt-2'>One Stop Service</p>
          <p className='card_text pb-4'>Layanan pengecekan kendaraan & cuci mobil garansi produk ban*</p>
        </div>
      </div>
      <div className="col-lg-2 col-md-4 col-6 pt-md-3 pt-lg-0 pt-3">
        <div className="card cards_custom_design align-items-center">
          <img src="assets/card-icon-4.png" className='pt-2' alt="Logo"/>
          <p className='card_heading pt-2'>Bebas Biaya Tambahan</p>
          <p className='card_text pb-4'>Gratis biaya pemasangan, balancing & pentil ban</p>
        </div>
      </div>
      <div className="col-lg-2 col-md-4 col-6 pt-md-3 pt-lg-0 pt-3">
        <div className="card cards_custom_design align-items-center">
          <img src="assets/card-icon-5.png" className='pt-2' alt="Logo"/>
          <p className='card_heading pt-2'>Ditangani oleh Teknisi Berpengalaman</p>
          <p className='card_text pb-4'>Tersedia berbagai macam merk & tipe</p>
        </div>
      </div>
    </div>
...
<div className='container mt-5'>
  <div className='row'>
    <div className='col-12'>
      <h1>Solusi Terpercaya untuk Ban Anda</h1>
    </div>
  </div>
