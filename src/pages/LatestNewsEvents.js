        ...
        <div>
            ...
            <div className='container-fluid'>
                <div className='container'>
                    ...
                    <ul className="nav nav-tabs d-flex justify-content-center mb-3" id="ex1" role="tablist">
                    ...
                    <div className="card-body d-flex flex-column justify-content-between">
                        ...
                        <p className='text-start title-color'>News & Event, Gazoo Racing</p>
                    ...
                    <div className="col-sm-6 col-lg-4 mt-4 mt-md-0">
                        ...
                        <div className="card-body d-flex flex-column justify-content-between">
                                <div className='tips-event mt-2'>
                                <p className='text-start'>News & Event, Gazoo Racing</p>
                                <p className='text-start'>17 Jul 2023</p>
                                </div>
                                <p className="card-title fw-bold text-start">TOYOTA GAZOO Racing Raih Podium Pertama Monza 6 Jam yang Sangat Ketat Hingga Lap Terakhir</p>
                                <button type="button" class="btn btn-outline-dark w-100 py-1 mt-2 mt-md-5 text-md-center">Find Out More <span className='d-block d-md-none'><i className="fas fa-chevron-right bg-white"></i></span></button>
        ...
        <div className="card mt-4 mt-lg-0" style={{width: "18rem"}}>
          ...
          <div className="card-body d-flex flex-column justify-content-between">
            ...
            <div className='container  mb-5'>
                <div className='d-flex justify-content-center'>
            <button type="button" class="btn btn-outline-dark w-50 py-2 mt-3 d-block d-md-none">Show More</button>
            </div>
            </div>
