...
const Faq = () => {
  return (
    ...
    <input type="text" class="form-control form-controll" placeholder="Type your questions"/>
  </div>
      </div>
        ...
        <div class="accordions px-lg-5" id="accordionExample">
            ...
            >
              <div class="accordion-body">
                <p class="iner_contect text-start">
                  Haha no, our goal is to rank you on the top of the first page
                  of Google. Arbitrarily writing blog posts and rolling the dice
                  on your content won’t achieve that.
                  <br />
                </p>
              </div>
            </div>
          ...
          <div class="accordion-item mt-2 back_color_set">
            <h2 class="accordion-header">
              ...
              >
                <b>
                  Kenapa servis setiap 6 bulan penting walaupun kilometer 10,000
                  km belum tercapai?
                </b>
              </button>
            </h2>
            ...
            >
              <div class="accordion-body">
                <p class="iner_contect text-start">
                  Yes, we don’t believe in slowly dripping out your solution. We
                  will work at lightning speeds to get all your content to you
                  ASAP.
                </p>
              </div>
            </div>
          ...
          <div class="accordion-item mt-2 back_color_set">
            <h2 class="accordion-header">
              ...
              >
                <b>
                  Kilometer kendaraan mencapai 10,000 km sebelum 6 bulan. Apakah
                  harus tetap servis setiap 6 bulan?
                </b>
              </button>
            </h2>
            <div
            ...
            >
              <div class="accordion-body">
                <p class="iner_contect text-start">
                  The topics are derived directly from your closest competitors
                  online. And before you say it, yes you do have competitors
                  online otherwise you’d already be on the first page of Google
                  for thousands of targeted keywords and not reading this page.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item mt-2 back_color_set">
            <h2 class="accordion-header">
              ...
              >
                <b>Apakah boleh saya bawa sendiri oli merk lain selain Toyota ke bengkel resmi?</b>
              </button>
            </h2>
            <div
              id="collapseseven"
