...
const handleOptionalTabs = async (variantId, serviceNo) => {
  ...
  console.log("response test null:", response.data.data)
  console.log("optionalvariantid:", variantId)

 if (response.data && response.data.data && response.data.data.length > 0) {
     const optionals = response.data.data[0].optionals;
     console.log("opppppppppp:", optionals)
...
const handleTab4Click = async (index) => {
  setActiveTab4(index);
  console.log("serviceactivetabbbb:", activeServiceTab);
