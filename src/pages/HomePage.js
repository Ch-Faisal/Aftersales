  ...
  return (
    <div>
      ...
      <div className="section-2 mt-5">
        <div className="container px-0">
          <div className="section-2-content px-0 px-md-5 mb-4">
            <div className="main-heading px-3 px-sm-0 pb-3 pb-md-0 text-center">
              <h1 className="fw-bold">
                Meningkatkan Kenyamanan Para Customer dengan Aftersales Test
              </h1>
            </div>
            <div className="section-text px-3 px-sm-0">
              <p>
            ...
            <div className="row mx-boxes align-items-stretch">
              <div className="col-6 col-md">
                <div className="wrapper border-0 mb-4 mb-md-3">
                  ...
                  <div className="title mt-4">
                    <h4 className="fw-bold text-dark cutom_heading_size">
              ...
              <div className="col-6 col-md w-50">
                <div className="wrapper border-0 mb-4 mb-md-3">
                  ...
                  <div className="title  mt-sm-5 mt-3 ">
                    <h4 className="fw-bold text-dark cutom_heading_size">
              ...
              <div className="col-6 mx-auto col-md d-flex justify-content-center">
                <div className="wrapper border-0 mb-4 mb-md-3">
                  <div className="section-img">
                    <img src="assets/location-icon.png" alt="" />
                  </div>
                  <div className="title mt-4">
                    <h4 className="fw-bold px-md-4 text-dark cutom_heading_size">
                      Jaringan yang luas
                    </h4>
                  </div>
                </div>
      ...
      <div className="container">
        <h1 className="pt-5 mb-4 mb-md-4">
                            ...
                            <div className="container mt-5">
                              <div className="servis-content mx-md-5">
                                ...
                                <p className="text mt-3">
                                  Berlaku Program T-CARE sampai servis ke 7 atau
                                  3 tahun untuk pembelian model baru mulai bulan
                                  Maret 2023
                                </p>
                              </div>
                                  ...
                                  <div className="d-flex justify-content-between mt-4">
                                    ...
                                    <div className="d-flex align-items-center mx-md-5">
                                      <img
                                        ...
                                        alt=""
                                      />
                                      <p className="px-3 px-md-0 mb-0 text-nowrap ">
                                        Pipa gas buang
                                      </p>
                                    </div>
                                  </div>
                              ...
                              <div className="d-none d-lg-block">
                                <div className="row mx-md-5">
                                  ...
                                  <div className="col-6 col-md">
                                    <div
                                      className="wrapper-servis border-0 mb-4 mb-md-3 h-100 mx-md-3 py-1 d-flex align-items-center justify-content-center"
                                      style={{
                                        backgroundColor: "rgba(215, 25, 33, 1)",
                                      }}
                                    >
                                      <div className="section-img ">
                                ...
                                <div className="row mx-5 mt-4">
                                  ...
                                  <div className="col-6 col-md">
                                    <div className="wrapper-servis border-0 mb-4 mb-md-3 h-100 py-4 mx-3  d-flex flex-column align-items-center justify-content-center">
                                      ...
                                      <p className="pt-2">
                                        Aerosol penghilang bakteri dan penyegar
                                        kabin
                                      </p>
                                    </div>
                                  </div>
                                ...
                                <button
                                  type="button"
                                  class="btn btn-outline-dark w-25 py-2 mt-5"
                                >
                                  Learn more
                                </button>
                              </div>
                          ...
                          >
                            ...
                            <div className="container">
                                    ...
                                    <div className="d-flex justify-content-between">
                                      <div className="d-flex mt-2 mt-md-4">
                                        <img
                                          ...
                                          alt=""
                                        />
                                        <p className="px-3 text-nowrap text-start">
                                          Saringan Oli
                                        </p>
                                      </div>
                                    </div>
                                  ...
                                  <div className="col-lg-12">
                                    <ul className="nav nav-pills nav-fill home-tab d-flex">
                                      <li className="nav-item mx-2">
                                        <a
                                          className={`nav-link text-nowrap rounded py-3 text-nowrap px-5 ${
                                            activeTab2 === 0 ? "active" : ""
                                          }`}
                                          href="javascript:void(0)"
                                  ...
                                  <div className="d-flex justify-content-center servis-2-tab">
                                    <div className="row mt-5">
                                      <p className="text px-md-5">
                                        Berlaku Program T-CARE sampai servis ke
                                        7 atau 3 tahun untuk pembelian model
                                        baru mulai bulan Maret 2023
                                      </p>
                                      <h1>TMO Oli Mesin</h1>
                                    ...
                                    <div className="row justify-content-md-center tmo-oli">
                                      <div className="col-md-3 bg-grey mx-md-2 text-center d-flex flex-md-column">
                                        <div className="col-6 order-1 order-md-0">
                                          ...
                                          <div className="tmo-image">
                                            <img
                                              src="assets/Group 1597880427.png"
                                              alt=""
                                            />
                                          </div>
                                        </div>
                                      ...
                                      <div className="col-md-3 bg-pink text-center d-flex flex-md-column mt-2 mt-md-0">
                                        ...
                                        <div className="col-6 order-0 order-md-1">
                                          ...
                                          >
                                            *Power comparison merupakan <br />{" "}
                                            perbandingan hp (Horse Power)
                                          </p>
                                        </div>
                                      </div>
                                    </div>
                              ...
                              {activeTab2 === 1 && (
                                <div>
                                  <div className="d-flex justify-content-center servis-2-tab">
                                    <div className="row mt-5">
                                      <p className="text px-md-5">
                                        Test Berlaku Program T-CARE sampai
                                        servis ke 7 atau 3 tahun untuk pembelian
                                        model baru mulai bulan Maret 2023
                                      </p>
                              ...
                              <p
                                ...
                                style={{ color: "rgba(215, 25, 33, 1)" }}
                              >
                                *Power comparison merupakan perbandingan hp
                                (Horse Power)
                              </p>
                            </div>
                          </div>
                                  ...
                                  <div className="col-lg-4 d-none d-md-block">
                                    <div className="d-flex justify-content-between">
                                      <div className="d-flex align-items-start">
                                        ...
                                        <div className="d-flex flex-column ">
                                          <li className="px-3 fw-bold text-start">
                                            TMO Oli Mesin
                                          </li>
                                          <li className="px-3 fw-bold text-start">
                                            TMO Lubricant Manual{" "}
                                            <span className="ms-4">
                                              Transmission Fluid
                                            </span>
                                          </li>
                                          <li className="px-3 fw-bold text-start">
                                            TMO Lubricant Differential Gear Oil
                                          </li>
                                          <li className="px-3 fw-bold text-start">
                                            TMO Lubricant Transfer{" "}
                                            <span className="ms-4"></span>Gear
                                            Oil
                                          </li>
                                        </div>
                                      </div>
                                    ...
                                    <div className="d-flex justify-content-between">
                                      <div className="d-flex align-items-start mt-2 mt-md-4">
                                        <img
                                          src="assets/Saringan Oli.png"
                                          alt=""
                                        />
                                        <li className="px-3 text-nowrap list-unstyled fw-bold">
                                          Saringan Oli
                                        </li>
                                      </div>
                                    </div>
                                    ...
                                    <div className="d-flex justify-content-between">
                                      <div className="d-flex align-items-start mt-2 mt-md-4">
                                        <img
                                          ...
                                          alt=""
                                        />
                                        <li className="px-3 list-unstyled text-nowrap fw-bold text-start">
                                          Saringan Udara Gasoline
                                        </li>
                                      </div>
                                    </div>
                                    <div className="d-flex justify-content-between">
                                      <div className="d-flex align-items-start mt-2 mt-md-4">
                                        <img
                                          ...
                                          alt=""
                                        />
                                        <li className=" list-unstyled px-3 text-nowrap fw-bold text-start">
                                          Gasket Oli Mesin
                                        </li>
                                      </div>
                                    </div>
                          ...
                          >
                            <div className="container ps-lg-5 pe-lg-5 mt-5">
                              <div className="servis-content mx-md-5">
                                ...
                                <p className="text text-start mt-5 mx-5">
                                  <span className="d-block">
                                    1. Harga yang tertera hanya estimasi dengan
                                    menggunakan TMO 10W-30 (gasoline) dan TMO
                                    15W-40 (diesel), untuk Raize & Voxy
                                    menggunakan TMO 5W-30 (gasoline), dan LC300
                                    menggunakan TMO 5W-30 (diesel). Harga di
                                    dealer dapat berbeda sesuai layanan tambahan
                                    yang diberikan dealer dan permintaan
                                    pelanggan
                                  </span>
                                  <span className="d-block">
                                    2.Dalam satuan Rupiah{" "}
                                  </span>
                                  <span className="d-block">
                                    3.Per Oktober 2022{" "}
                                  </span>
                            ...
                            <div className="d-flex justify-content-center mt-5">
                              <img
                                ...
                                className="mx-4 px-2 py-3"
                                alt=""
                                style={{
                                  borderRadius: "10px",
                                  border: "2px solid rgba(215, 25, 33, 1)",
                                }}
                              />
                              <img
                                src="assets/tmo.png"
      ...
      <div className="section-3 mt-5">
        <div className="container">
          <h1 className="fw-bold title-2">
            Hanya Bengkel Resmi Toyota yang mengerti{" "}
          </h1>
          <h1 className="fw-bold"> kendaraan Toyota Anda </h1>
          <p className="mb-5 heading_discription">
          ...
          <div className="row px-5 px-sm-0">
            ...
            <div className="col-sm-6 col-lg-4 pt-4 pt-sm-0 pb-4 pb-lg-0">
              <div className="card custom_body_boder  mt-4 mt-lg-0">
                <img
          ...
          <div className="row mt-5 px-5 px-sm-0">
            <div className="col-sm-6 col-lg-4">
              <div className="card custom_body_boder mt-4 mt-lg-0">
                ...
                />
                <div className="card-body">
                  <h4 className="card-title fw-bold">T-Care</h4>
                  <button
                    type="button"
                    class="btn btn-outline-dark w-100 py-1 mt-4"
                  >
            ...
            <div className="col-sm-6 col-lg-4 pt-4 pt-sm-0">
              <div className="card custom_body_boder mt-4 mt-lg-0">
                ...
                />
                <div className="card-body">
                  <h4 className="card-title fw-bold">News-Event</h4>
                  <button
                    type="button"
                    class="btn btn-outline-dark w-100 py-1 mt-4"
                  >
            ...
            <div className="col-sm-6 col-lg-4 mb-4 mb-md-0 mt-4 mt-lg-0">
              <div className="card custom_body_boder mt-4 mt-lg-0">
                <img
                  src="assets/faq.png"
                  className=" rounded-0"
                ...
                />
                <div className="card-body">
                  <h4 className="card-title fw-bold">FAQ</h4>
                  <button
                    type="button"
                    class="btn btn-outline-dark w-100 py-1 mt-4"
                  >
